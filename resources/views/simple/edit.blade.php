                    ...
                    <div class="ibox-content">
                        ...
                        <div class="box-content">
                            ...
                            <div class="table-responsive form_simple">
                                ...
                                <div class="clearfix"></div>
                                <form action="{{ $simple->id }}" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="name">Your Name</label>
                                            <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $simple->name) }}">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="image_thumbnail">
                                                <img src="/uploads/image/{{ $simple->thumbnail }}" alt="">
                                            </div>
                                    ...
                                    <div class="form-group form-date">
                                        ...
                                        <div class="col-sm-6 js-schedule-date" id="js-start-date">
                                            <div class="input-group date">
                                                ...
                                                <input name="from_date" type="text" class="form-control js-start-date js-only-number" value="{{ old('from_date', $simple->from_date) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="input-group clockpicker" data-autoclose="true">
                                                <input name="from_hour" type="text" class="form-control js-nokeyboard" value="{{ old('from_hour',$simple->from_hour) }}">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="note" id="note" cols="30" rows="10" class="mceEditor">{{ old('note', $simple->note) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12"><input type="submit" value="Update" class="btn btn-success"></div>
                                </form>
                            </div>
                        </div>
                    </div>
